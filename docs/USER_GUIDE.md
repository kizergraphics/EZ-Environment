...
The grouped catalog has 27 Plant presets and 22 Rock presets. Plant forms include shrubs, bushes, saplings, ferns, weeds, ground cover, flowers, grasses, young conifers, cactus, succulents, cushions, and deadwood. Rock forms include pebbles, individual rocks, boulders, spaced clusters, slabs, and connected outcrops. Authored rock materials use color, roughness, vertex color variation, strata, and upward-facing moss/lichen tint. Environment biome rocks additionally use bundled sandstone or weathered-stone textures. See [the complete preset catalog](PRESET_EXPANSION.md).
