...
The grouped catalog has 27 Plant presets and 22 Rock presets. Plant forms include shrubs, bushes, saplings, ferns, weeds, ground cover, flowers, grasses, young conifers, cactus, succulents, cushions, and deadwood. Rock forms include pebbles, individual rocks, boulders, spaced clusters, slabs, and connected outcrops. Generated surfaces automatically receive color, normal, and roughness textures. Plant stems, foliage, petals, and centers retain their own materials; rock textures combine with color, roughness, variation, strata, and moss/lichen controls. Every LOD uses the same surface treatment. See [the complete preset catalog](PRESET_EXPANSION.md).
